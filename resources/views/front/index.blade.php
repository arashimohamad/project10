                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 u-s-m-b-30">
                                <a class="collection" href="{{$homeFixBanners[1]['link']}}" title="{{ $homeFixBanners[1]['title'] }}"> 
                                    <div class="aspect aspect--bg-grey aspect--1286-890">
                                        <img class="aspect__img collection__img" src="{{asset('front/images/banners/'.$homeFixBanners[1]['image'])}}" alt="$homeFixBanners[1]['alt']">
                                    </div>
                                </a>
                            </div>
                        @endif
                        @if (isset($homeFixBanners[2]['image']))
                            <div class="col-lg-7 col-md-7 u-s-m-b-30">
                                <a class="collection" href="{{$homeFixBanners[2]['link']}}" title="{{ $homeFixBanners[2]['title'] }}"> 
                                    <div class="aspect aspect--bg-grey aspect--1286-890">
                                        <img class="aspect__img collection__img" src="{{asset('front/images/banners/'.$homeFixBanners[2]['image'])}}" alt="$homeFixBanners[2]['alt']">
                                    </div>
                                </a>
                            </div>
                        @endif
                        @if (isset($homeFixBanners[3]['image']))
                            <div class="col-lg-5 col-md-5 u-s-m-b-30">
                                <a class="collection" href="{{$homeFixBanners[3]['link']}}" title="{{ $homeFixBanners[3]['title'] }}"> 
                                    <div class="aspect aspect--bg-grey aspect--square">
                                        <img class="aspect__img collection__img" src="{{asset('front/images/banners/'.$homeFixBanners[3]['image'])}}" alt="$homeFixBanners[3]['alt']">
                                    </div>
                                </a>
                            </div>
                        @endif --}}
                                    ...
                                    @foreach ($newProducts as $product)
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item newarrivals">
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                ...
                                                <a href="shop-side-version-2.html">{{ $product->brand->brand_name }}</a></span>  {{-- Option 1 --}}
                                                {{-- <a href="shop-side-version-2.html">{{ $product['brand']['brand_name'] }}</a></span> Option 2 --}}                                                
