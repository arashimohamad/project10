                            ...
                            <div class="l-f-o__pad-box">
                                ...
                                <form class="l-f-o__form" id="loginForm" action="javascript:;" method="POST">
                                    ...
                                    <div class="u-s-m-b-30">
                                        ...
                                        <input class="input-text input-text--primary-style" type="text" id="login-email" name="email" 
                                        placeholder="Enter E-mail" value="<?php if(isset($_COOKIE['user-email'])) { echo $_COOKIE['user-email']; }?>">
                                        <p class="login-email"></p>
                                        <p id="login-error"></p>
                                    </div>
                                    <div class="u-s-m-b-30">
                                        <label class="gl-label" for="login-password">PASSWORD *</label>
                                        <input class="input-text input-text--primary-style" type="password" id="login-password" name="password" 
                                        placeholder="Enter Password" value="<?php if(isset($_COOKIE['user-password'])) { echo $_COOKIE['user-password']; }?>">
